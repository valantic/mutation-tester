...
public final class SettingsEditorService {
    ...
    private void resetFields(final MutationSettingsEditor mutationSettingsEditor, final MutationConfigurationOptions options) {
        ...
        resetTextField(mutationSettingsEditor.repoUrl, options.getRepoUrl());
        resetTextField(mutationSettingsEditor.pitestVersion, options.getPitestVersion());
        resetTextField(mutationSettingsEditor.pitestJunit5Version, options.getPitestJunit5Version());
        resetTextField(mutationSettingsEditor.junitJupiterVersion, options.getJunitJupiterVersion());
    ...
    private void applyValuesToOptions(final MutationSettingsEditor mutationSettingsEditor, final MutationConfigurationOptions options) {
        ...
        // PIT
        options.setRepoUrl(mutationSettingsEditor.repoUrl.getComponent().getText());
        options.setPitestVersion(mutationSettingsEditor.pitestVersion.getComponent().getText());
        options.setPitestJunit5Version(mutationSettingsEditor.pitestJunit5Version.getComponent().getText());
        options.setJunitJupiterVersion(mutationSettingsEditor.junitJupiterVersion.getComponent().getText());
    }
}
