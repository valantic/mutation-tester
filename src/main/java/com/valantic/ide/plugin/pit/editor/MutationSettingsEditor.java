 ...
 */
package com.valantic.ide.plugin.pit.editor;
...
import com.valantic.ide.plugin.pit.services.impl.SettingsEditorService;
...
public class MutationSettingsEditor extends SettingsEditor<MutationConfiguration> {
    ...
    public LabeledComponent<EditorTextField> repoUrl;
    public LabeledComponent<EditorTextField> pitestVersion;
    public LabeledComponent<EditorTextField> pitestJunit5Version;
    public LabeledComponent<EditorTextField> junitJupiterVersion;
    ...
    protected void createUIComponents() {
        ...
        // pit
        repoUrl = new LabeledComponent<>();
        pitestVersion = new LabeledComponent<>();
        pitestJunit5Version = new LabeledComponent<>();
        junitJupiterVersion = new LabeledComponent<>();
    ...
    protected void setUIComponents() {
        ...
        // pit
        repoUrl.setComponent(new EditorTextField());
        pitestVersion.setComponent(new EditorTextField());
        pitestJunit5Version.setComponent(new EditorTextField());
        junitJupiterVersion.setComponent(new EditorTextField());
    }
