...
import com.valantic.ide.plugin.pit.editor.MutationSettingsEditor;
import com.valantic.ide.plugin.pit.enums.Mutations;
...
class SettingsEditorServiceTest {
    ...
    void testResetEditorFrom() {
        ...
        verify(editorTextField, times(27)).setText(null);
    ...
    @Test
    void testApplyEditorTo_pitSettings() {
        MutationConfiguration mutationConfiguration = mock(MutationConfiguration.class);
        MutationConfigurationOptions mutationConfigurationOptions = mock(MutationConfigurationOptions.class);
        MutationSettingsEditor mutationSettingsEditor = mockMutationSettingsEditor();
        Object selectedObject = mock(Object.class);
        ...
        verify(mutationConfigurationOptions).setRepoUrl(anyString());
        verify(mutationConfigurationOptions).setPitestVersion(anyString());
        verify(mutationConfigurationOptions).setPitestJunit5Version(anyString());
        verify(mutationConfigurationOptions).setJunitJupiterVersion(anyString());
    }
    ...
    private MutationSettingsEditor mockMutationSettingsEditor() {
        ...
        final LabeledComponent<EditorTextField> repoUrl = mock(LabeledComponent.class);
        final LabeledComponent<EditorTextField> pitestVersion = mock(LabeledComponent.class);
        final LabeledComponent<EditorTextField> pitestJunit5Version = mock(LabeledComponent.class);
        final LabeledComponent<EditorTextField> junitJupiterVersion = mock(LabeledComponent.class);
        ...
        when(repoUrl.getComponent()).thenReturn(editorTextField);
        when(pitestVersion.getComponent()).thenReturn(editorTextField);
        when(pitestJunit5Version.getComponent()).thenReturn(editorTextField);
        when(junitJupiterVersion.getComponent()).thenReturn(editorTextField);
        ...
        mutationSettingsEditor.repoUrl = repoUrl;
        mutationSettingsEditor.pitestVersion = pitestVersion;
        mutationSettingsEditor.pitestJunit5Version = pitestJunit5Version;
        mutationSettingsEditor.junitJupiterVersion = junitJupiterVersion;
